...
import de.adorsys.datasafe.business.impl.privatespace.actions.EncryptedResourceResolverImpl;
...
public final class DaggerDefaultDocusafeServices implements DefaultDocusafeServices {
  ...
  private DaggerDefaultDocusafeServices(Builder builder) {
    initialize(builder);
  }

  public static DefaultDocusafeServices.Builder builder() {
    return new Builder();
  }
  ...
  private ListPrivateImpl getListPrivateImpl() {
    return new ListPrivateImpl(getEncryptedResourceResolverImpl(), storageList);
  }
  ...
  private static final class Builder implements DefaultDocusafeServices.Builder {
    private DFSConfig config;
    ...
    @Override
    public DefaultDocusafeServices build() {
      if (config == null) {
      ...
      return new DaggerDefaultDocusafeServices(this);
    }
