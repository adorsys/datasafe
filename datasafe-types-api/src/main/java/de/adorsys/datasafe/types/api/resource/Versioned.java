...
public interface Versioned<T, S, V extends Version> {
    ...
    /**
     * Resource or path to the resource with version (typically physical resource location)
     */
    T absolute();

    /**
     * Resource or path to the resource without version (typically some logical location)
     */
    S stripVersion();
