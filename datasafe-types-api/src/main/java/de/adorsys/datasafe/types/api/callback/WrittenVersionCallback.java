...
/**
 * Called when file is persisted on storage that supports versioning (either software or natively versioned)
 ...
 */
@FunctionalInterface
public interface WrittenVersionCallback extends ResourceWriteCallback {
